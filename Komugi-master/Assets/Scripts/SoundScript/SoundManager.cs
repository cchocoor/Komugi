...
public class SoundManager : MonoBehaviour
{
    ...
    public static SoundManager Instance
    {
        get
        {
            if (instance == null)
            {
                ...
                //Debug.Log("SoundManager Instance Success");
            }
    ...
    // SE(loop)
    private AudioSource[] SELoopsources = new AudioSource[16];
    // 音声
    ...
    void Awake()
    {
        ...
        // SE AudioSource(loop)
        for (int i = 0; i < SELoopsources.Length; i++)
        {
            SELoopsources[i] = gameObject.AddComponent<AudioSource>();
			SELoopsources[i].loop = true;
        }
    ...
    void Update()
    {
        ...
        foreach (AudioSource source in SELoopsources)
        {
            source.mute = volume.Mute;
        }
    ...
    {
        if (0 > index || SELoop.Length <= index)
        {
            return;
        }
