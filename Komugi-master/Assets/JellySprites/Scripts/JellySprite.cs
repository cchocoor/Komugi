	...
	void Start()
	{
		if(IsSpriteValid())
		{
			...
			if(Application.isPlaying)
			{
				...
				// add rikako
				m_ReferencePointParent.AddComponent<Komugi_1>();
...
#else
								Physics2D.IgnoreCollision(m_ReferencePoints[referencePointIndex].Body2D.GetComponent<Collider2D>(), m_ReferencePoints[comparisonPointIndex].Body2D.GetComponent<Collider2D>());
#endif
							}
